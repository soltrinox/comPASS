# comPASS — Product & GTM docs (Track E)

Working name: **comPASS** (package `compass-router`) until [ADR 0001](../adr/0001-product-name.md) is Accepted.
...
- [0001-product-name.md](../adr/0001-product-name.md) — G3 (proposed, awaiting Rosario)
- [0002-working-copy-disposition.md](../adr/0002-working-copy-disposition.md) — G2 (recommended default recorded)

Ground truth: `/Users/rosario/work/comPASS/PROTOTYPE.md` Part I (§1–§8), §16, Appendix A.
